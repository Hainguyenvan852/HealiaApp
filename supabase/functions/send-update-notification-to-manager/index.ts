...
serve(async (req) => {
  try {
    ...
    const title = "📅 Có thay đổi về lịch hẹn!";
    const body = `Khách hàng vừa cập nhật thông tin cho một lịch hẹn. Vui lòng mở ứng dụng để kiểm tra và sắp xếp lại công việc nhé.`;
