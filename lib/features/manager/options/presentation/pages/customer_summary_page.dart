...
class CustomerSummaryPage extends StatefulWidget {
  const CustomerSummaryPage({Key? key}) : super(key: key);
  ...
  Future<void> _fetchData() async {
    try {
      ...
      for (var client in clients) {
        if (client.createdAt.isAfter(
              _startDate.subtract(const Duration(seconds: 1)),
            ) &&
            client.createdAt.isBefore(filterEnd)) {
          total++;

          if (client.profileId != null && client.profileId!.isNotEmpty) {
            onlineBookings++;
          } else {
            walkIns++;
          }
          ...
          final cDate = DateTime(
            ...
            client.createdAt.month,
            client.createdAt.day,
          );
          ...
          int dayIndex = cDate.difference(startDateMidnight).inDays;

          if (dayIndex >= 0 && dayIndex <= _daysCount) {
            dailyCounts[dayIndex]++;
          }
        } else if (client.createdAt.isAfter(
              _prevStartDate.subtract(const Duration(seconds: 1)),
            ) &&
            client.createdAt.isBefore(prevFilterEnd)) {
          prevTotal++;
        }
      }
      ...
      if (mounted) {
        setState(() {
          ...
          _onlineBookings = onlineBookings;
          _walkIns = walkIns;
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // --- Header: Title ---
                  Text(
                    AppLocalizations.of(context)!.customerSummary,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          AppLocalizations.of(context)!.newCustomers,
                                        ...
                                        return touchedSpots.map((spot) {
                                          ...
                                          return LineTooltipItem(
                                            ...
                                            children: [
                                              ...
                                              TextSpan(
                                                text:
                                                    '${AppLocalizations.of(context)!.newCustomers}: ${_mainChartData[spot.spotIndex].y.toStringAsFixed(0)}',
                                                style: GoogleFonts.quicksand(
                                                  color: Colors.white,
                                                  fontSize: 13,
                        ...
                        _buildStatRow(AppLocalizations.of(context)!.onlineBookings, _onlineBookings),
                        _buildStatRow(AppLocalizations.of(context)!.walkIns, _walkIns),
                      ],
                    ),
                  ),
