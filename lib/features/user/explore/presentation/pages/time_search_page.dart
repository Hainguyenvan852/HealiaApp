...
class _TimeSearchPageState extends State<TimeSearchPage> {
  ...
  void _onConfirmed(SearchFilterState state) {
    if (_selectedTimeType.toLowerCase() == 'custom' &&
      ...
      SnackBarHelper.showError(AppLocalizations.of(context)!.noTimeSelected);
    } else {
      if (_selectedTimeType.toLowerCase() == 'custom') {
        context.read<SearchFilterCubit>().updateSearch(
          state.copyWith(
            startTime: _selectedCustomTimeStart,
            endTime: _selectedCustomTimeEnd,
            date: _selectedDate,
            dateText: _selectedDateText,
            timeText: _selectedTimeType,
          ),
        );
        ...
        if (_selectedTimeType == 'Anytime' &&
            _selectedDateText == 'Any date' &&
            _selectedDate == null) {
          context.read<SearchFilterCubit>().clearDateTime(
            state.update(
                                      ...
                                      _selectedCustomTimeStart == null
                                          ...
                                          : AppLocalizations.of(context)!.from +
                                                DateTimeHelper.transformTime24To12(
                                                  _selectedCustomTimeStart!
                                                      .hour,
                                                  0,
                                                ),
                                      style: GoogleFonts.quicksand(
                                        color: _selectedCustomTimeStart == null
                                            ? Colors.grey
                                            : Colors.black,
                                        fontSize: 15,
                                      ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: GoogleFonts.quicksand(
                                        color: _selectedCustomTimeEnd == null
                                            ? Colors.grey
                                            : Colors.black,
                                        fontSize: 15,
                                      ),
  ...
  Future<TimeOfDay?> showTimePicker(
    ...
    return showMenu<TimeOfDay>(
      ...
      context: context,
      color: Colors.white,
      constraints: const BoxConstraints(maxHeight: 700, minWidth: 150),
