...
class _SearchPageState extends State<SearchPage> {
  ...
  Future<List<Map<String, dynamic>>> recentSearchFuture =
      RecentlySearchService.getRecentSearch();

  void _categorySearchOnTap(SearchFilterState state) async {
    final result = await context.push<String>(
      '/explore/search/category-search',
    );

    if (result != null) {
      setState(() {
        context.read<SearchFilterCubit>().updateSearch(
          state.copyWith(category: result),
        );
      });
    }
  }
  ...
  //   if (state.category != 'All treatments' ||
  //       state.dateText.toLowerCase() != 'any date' ||
  //       state.timeText.toLowerCase() != 'anytime' ||
  //       state.locationName.toLowerCase() != 'current location') {
  //     await RecentlySearchService.addRecentSearch(
  //       state.locationName,
  //       state.lat,
  //       state.lng,
  //       state.date,
  ...
  //       state.locationName.toLowerCase() != 'work' &&
  //       state.locationName.toLowerCase() != 'home' &&
  //       state.address != null &&
  //       state.lng != null &&
  //       state.lat != null) {
  //     await RecentlySearchService.addRecentLocation(
  //       state.locationName,
  //       state.address!,
  //       state.lat!,
  //       state.lng!,
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  //                     titleButton: AppLocalizations.of(context)!.clear,
                  //                     onPressed: () async {
