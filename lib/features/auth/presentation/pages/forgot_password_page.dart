...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  void _submitResetPasswordRequest(){
    if(_passwordKey.currentState!.validate()){
      context.read<AuthBloc>().add(ResetPasswordRequested(email: _passwordCtrl.text.trim()));
    }
  }
    ...
    return BlocConsumer<AuthBloc, OAuthState>(
        ...
        listener: (context, state){
          if(state is ResetPasswordRequestSuccess){
            SnackBarHelper.showSuccess('We have sent you an email. Please check it and follow the instructions.');
          }
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Forgot password', style: GoogleFonts.quicksand(
                          fontSize: 24,
